...
WORLD.calculators.prototype.pointSun = function(point) {
  ...
  // угол падения солнечных лучей в точку в полдень в радианах (используется для расчета среднесуточной температуры)
		...
		point.heat = temp*(map.temper.tempmax-map.temper.tempmin)+map.temper.tempmin; //надо добавить влияние среднесуточного количества теплоты, высоты местности, наличие вод и их глубины
